...
void CSpawnScreen::Render()
{
	...
	if(pPlayerPool)
	{
		...
		if(pLocalPlayer)
		{
			...
			ImGui::Begin("SpawnScreen", nullptr, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoSavedSettings);
